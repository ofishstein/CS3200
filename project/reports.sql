...
FROM
	...
	FROM Movie m INNER JOIN Credit c ON m.movieId = c.movieId INNER JOIN MovieOrder mo ON mo.movieId = m.movieId INNER JOIN Professional p ON p.personId = c.personId
